...
from ansible_collections.extreme.nos.plugins.modules import nos_facts
...
class TestNosFactsModule(TestNosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.extreme.nos.plugins.modules.nos_facts.run_commands')
