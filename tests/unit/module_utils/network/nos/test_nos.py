...
from ansible_collections.extreme.nos.tests.unit.compat import unittest
from ansible_collections.extreme.nos.plugins.module_utils.network.nos import nos
...
class TestPluginCLIConfNOS(unittest.TestCase):
    ...
    @patch('ansible_collections.extreme.nos.plugins.module_utils.network.nos.nos.Connection')
